...
Scoring guide:
- sterility_score: based on relevant air quality parameters from the dataset.
- storage_score: based on temperature and humidity. Penalize values outside ideal range for the given environment type.
- compliance_score: overall compliance across all parameters. Set alert to true if any parameter is outside safe range or door is open.
- recommendation: one concise sentence on the most important action to take. A second sentence on the implications if ignored.
