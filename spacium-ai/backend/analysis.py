...
- recommendation: one concise sentence describing the most important action to take. A second concise sentence for the implications the problem could lead to.
